...
<body>
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="http://localhost/hms-project/HMS-master/HMS-master/Doctor/indexDoctor.php" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="http://localhost/hms-project/HMS-master/HMS-master/Doctor/indexDoctor.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="http://localhost/hms-project/HMS-master/HMS-master/Doctor/indexDoctor.php">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="reserveDoktor.php">
              <i class="bi bi-circle"></i><span>Shiko Takime</span>
            </a>
          </li> 
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="http://localhost/hms-project/HMS-master/HMS-master/Doctor/editProfil.php">
          <i class="bi bi-person"></i>
