                    ...
                    <div class="card-body">
                        <form action="reset_password.php" method="POST" id="form">
                            <div class="form-group mb-3">
                                <label> Email-i</label>
                                <input type="email" name="email"  id="email" class="form-control" placeholder="Vendosni adresen tuaj te email-it"  required oninvalid="this.setCustomValidity('Ju lutem plotësoni email-in !')" oninput="this.setCustomValidity('')"></label>
                                <span class="error" id='message3'></span></span>
                            </div>
                            <div class="form-group mb-3">
                                <button id ="btn" type="submit"  name="reset_password_link" class="btn btn-success">Dergo</button>
                            </div>
