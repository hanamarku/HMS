  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <i class='fas fa-file-invoice-dollar'></i><span>Feedback</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/hms-project/HMS-master/HMS-master/Patient/Feedback/index.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="http://localhost/hms-project/HMS-master/HMS-master/Patient/editProfil.php">
